...
public class Main {
	...
	/**
	 * <h1>AmazonViewer</h1>
	 * AmazonViewer es un programa que permite vizualizar Movies, Series con sus respectivos Chapters,
	 * Books y Magazines. Te permite generar reportes generales y con fechas del día.
	 * <br>
	 *Existen algunas reglas, como que todos los elementos deben ser visualizados o leidos a excepción
	 * de los Magazines, estas pueden ser vistas a modo de exposición sin ser leidas.
	 * <p>
